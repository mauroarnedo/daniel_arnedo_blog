...
const Contact = () => {
    ...
    return (
        <div className="contact-container">
            <h2>Contacto</h2>
            <p>
            Bienvenido/a a mi sección de contacto. Estoy interesado de tener la oportunidad de conectarme contigo. <br/>
            ...
            compartir tus pensamientos sobre el mundo del arte, siempre estoy dispuesto a escuchar. <br/>
